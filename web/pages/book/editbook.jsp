...
<body class="linear">
	...
	<div class="row container bs-docs-container" style="width: 100%">
		<h3 style="text-align: center;">编辑图书</h3>
		<div class="col-md-4"></div>
		<c:if test="${not empty loginUser}">
			<div class="bs-docs-section col-md-6">
				<form method="post" action="${ctx}/book.do?type=edit"
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="bookName"
								id="bookName" value="${book.bookName}" placeholder="书名">
						</div>
						<div class="col-sm-5">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="author" id="author"
								value="${book.author}" placeholder="作者">
						</div>
						<div class="col-sm-5">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="publisher"
								id="publisher" value="${book.publisher}" placeholder="出版社">
						</div>
						<div class="col-sm-5">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="bookNumbers"
								id="bookNumbers" value="${book.bookNumbers}" placeholder="图书数量">
						</div>
						<div class="col-sm-5">
